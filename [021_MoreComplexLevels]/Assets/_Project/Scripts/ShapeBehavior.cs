...
public static class ShapeBehaviorTypeMethods
{
    public static ShapeBehavior GetInstance(this ShapeBehaviorType type)
    {
        switch (type)
        {
            ...
            case ShapeBehaviorType.Grow:
                return ShapeBehaviorPool<ShapeBehaviorGrow>.Get();
            case ShapeBehaviorType.Die:
                return ShapeBehaviorPool<ShapeBehaviorDie>.Get();
            case ShapeBehaviorType.Lifecycle:
                return ShapeBehaviorPool<ShapeBehaviorLifecycle>.Get();
        }
